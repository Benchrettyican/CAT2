...
<div class="row">
<div class="col-md-12">
<h3> CAR PARKING CONTROL Report</h3> <br>
...
<a href="#.php"><button class="btn btn-primary"> Report</button></a>
...
// 
$sql1 = "SELECT `id`, `fullname`, `email`, `tel`, `plate`, `place`, `calendar`,
 `start_time`, `end_time`,sum(`cost`) as cost FROM `user` WHERE calendar='$todate'";
...
echo "Total Amount : <b>".$results1->cost. ' rwf<b>';
// 

$sql = "SELECT `id`, `fullname`, `email`, `tel`, `plate`, `place`, `calendar`,
 `start_time`, `end_time`,`cost` FROM `user` WHERE calendar='$todate'";
